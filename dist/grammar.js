...
function GWLanguage() {
    return {
        grammar: {
            ...
            rules: {
                Body: [
                    { name: "Body", symbols: ["_", "Statements", "_"], postprocess: ({ data }) => { return { statements: data[1] }; } },
                    { name: "Body", symbols: ["_", "Exp", "_"], postprocess: ({ data }) => { return { expression: data[1] }; } }
                ],
                Statements: [
        ...
        lexer: {
            ...
            states: {
                root: {
                    ...
                    rules: [
                        { import: ["keywords"] },
                        { when: /"/, tag: ["dquote"], highlight: "string", goto: "dqstring" },
                        { when: /'/, tag: ["squote"], highlight: "string", goto: "sqstring" },
