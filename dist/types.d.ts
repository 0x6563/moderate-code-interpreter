...
export type ValueTypeNull = {
    type: 'value';
    kind: "null";
    value: null;
};
export type ValueTypeString = {
    type: 'value';
    kind: "string";
    value: string;
};
export type ValueTypeNumber = {
    type: 'value';
    kind: "number";
    value: number;
};
export type ValueTypeBoolean = {
    type: 'value';
    kind: "boolean";
    value: boolean;
};
...
export type ControlTypeError = {
    type: 'control';
    kind: "error";
    value: any;
};
export type ControlTypeContinue = {
    type: 'control';
    kind: "continue";
};
export type ControlTypeBreak = {
    type: 'control';
    kind: "break";
    value: ValueType;
};
export type ControlTypeReturn = {
    type: 'control';
    kind: "return";
    value: ValueType;
};
export type ControlType = ControlTypeError | ControlTypeContinue | ControlTypeBreak | ControlTypeReturn;
export type LiteralExpressionString = {
    type: 'literal';
    kind: 'string';
    value: string;
};
export type LiteralExpressionNumber = {
    type: 'literal';
    kind: 'number';
    value: string;
};
export type LiteralExpressionBoolean = {
    type: 'literal';
    kind: 'boolean';
    value: string;
};
export type LiteralExpressionNull = {
    type: 'literal';
    kind: 'null';
    value: string;
};
...
export type StatementDeclareConstant = {
    type: 'declare';
    kind: 'const';
    name: string;
    value: Expression;
};
export type StatementDeclareVariable = {
    type: 'declare';
    kind: 'var';
    name: string;
    value: Expression;
};
export type StatementDeclareFunction = {
    type: 'declare';
    kind: 'function';
    name: string;
    args: FunctionArgument[];
...
export type StatementConditional = {
    type: 'conditional';
